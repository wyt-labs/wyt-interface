...
export interface IsExpiredResponse {
  code?: number;
  /** true if expired */
  data?: boolean;
  message?: string;
...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = 'https://wyt.bauhiniachain.com';
 ...
 * @version 1.0.0
 * @baseUrl https://wyt.bauhiniachain.com
 *
 * API for wallet login and user management
 */
export class Api<
...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @request GET:/api/v1/user/is-expired
     */
    isExpired: (
      query: {
        /** Login address */
      ...
      this.request<IsExpiredResponse, any>({
        path: `/api/v1/user/is-expired`,
        method: 'GET',
        query: query,
        format: 'json',
        ...params,
