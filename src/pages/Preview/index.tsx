...
import { ReactComponent as PreviewUnpublished } from '@/assets/svg/preview/preview_unpublished.svg';
import { ReactComponent as PreviewUpdated } from '@/assets/svg/preview/preview_updated.svg';
import Tokennomics from '../Detail/components/tokenomics';
import Profitability from '../Detail/components/profitability';
import Team from '../Detail/components/team';
import Funding from '../Detail/components/funding';
import Exchanges from '../Detail/components/exchanges';
import Ecosystem from '../Detail/components/ecosystem';
import MoreInfo from '../Detail/components/more_info';
...
const Preview = (props: IRouteComponentProps & UmiComponentProps) => {
  ...
  useEffect(() => {
    const getDetail = async () => {
      const detailResult = await getProjectInfo(location.query.id as string);
  ...
  return (
    <>
      ...
      >
        <div className="bg-white border border-solid rounded-2xl shadow-md p-8 mt-10">
          <div className="flex">
            <div>
              <div className="flex">
                <Image
            ...
            <div className="w-0 h-0 overflow-visible">
              {detail?.status === 0 && <PreviewUnpublished className="relative" style={{ left: -250, top: -80 }} />}
              {detail?.status === 2 && <PreviewUpdated className="relative" style={{ left: -250, top: -80 }} />}
            </div>
          </div>
